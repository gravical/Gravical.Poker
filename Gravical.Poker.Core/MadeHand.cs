...
namespace Gravical.Poker.Core
{
    ...
    public class MadeHand
    {
        ...
        {
            Guards.ArgumentHasExactSize(binary, 26, nameof(binary));
        ...
        private void ScoreHand()
        {
            ...
            Score = BitConverter.ToInt64(scoring, 0);
        }

        public static MadeHand MakeHand(Card[] cards)
        {
            Guards.OperationSuccess(cards.Length >= 5 && cards.Length <= 7, $"Can't make a hand with {cards.Length} cards");
